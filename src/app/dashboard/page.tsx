...
          <div className="mb-6">
            <h1 className="text-xl md:text-2xl font-bold text-slate-900 tracking-tight">Bem-vinda, {perfil.nome.split(' ')[0]}</h1>
...
            </div>
            ...
            {/* 2. INTERFACE MOBILE: Cartões Rápidos de Toque (Substitui a tabela no celular) */}
...
      </div>
      ...
      {/* 3. FUNCIONALIDADE: LINHA DO TEMPO DO PACIENTE (MODAL RESPONSIVO) */}
      {pacienteSelecionado && (
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center p-0 md:p-4 animate-fade-in">
          ...
          <div className="relative w-full md:max-w-md bg-white rounded-t-2xl md:rounded-2xl shadow-xl border border-slate-200 overflow-hidden flex flex-col max-h-[85vh] md:max-h-[75vh] z-10">
            ...
            {/* Conteúdo: Linha do Tempo Estilizada */}
